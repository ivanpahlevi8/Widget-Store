...
CREATE TABLE `orders` (
  ...
  KEY `orders_customers_id_fk` (`customers_id`),
...
CREATE TABLE `transactions` (
  ...
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp(),
  `expired_month` int(11) NOT NULL DEFAULT 0,
  `expired_year` int(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `widgets` (
  ...
  `is_reccuring` tinyint(1) NOT NULL DEFAULT 0,
  `plan_id` varchar(50) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2023-10-11  8:11:34
